...
class Environment:
    def __init__(self):
        ...
        self.target_position = self.config.environment.target_position
    ...
    def _reset_all_envs(self, sub_rngs: jnp.ndarray):
        ...
        target_position_for_all_envs = jnp.broadcast_to(jnp.array(self.target_position), (self.number_of_environments, 3)) # shape: (envs, 3)
