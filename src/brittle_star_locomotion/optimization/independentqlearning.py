...
class IndependentQLearning:
    def __init__(self, optimizer: optax.GradientTransformationExtraArgs, n_agents: int, env: Environment, **kwargs):
        ...
        self.value_network = QNetwork(self.observation_size, config.rl.action_space_dim, rngs=nnx.Rngs(0))

        # Target Q-Network (The stable reference for calculating TD targets)
        self.target_network = QNetwork(self.observation_size, config.rl.action_space_dim, rngs=nnx.Rngs(0))
