import {BaseObject, assign, copy, get, init, merge, set} from './__util__.js';

class XOffset extends BaseObject {
  ...
  toObject(flag) {
    return flag ? {xOffset: super.toObject()} : super.toObject();
  }

}

export function xOffset(...args) {
  return new XOffset(...args);
}